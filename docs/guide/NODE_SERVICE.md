...
Oasis's Node Service is your high-performance access to all major blockchains, with supercharged reliability, data correctness, and scalability.
...
Authenticate yourself to the Oasis Node Service API

---

#### Endpoint

**Base URL: https://api.Oasis.network**
...
https://api.Oasis.network/solana/rpc

All EVM-compatible chains' RPC URL is:
https://api.Oasis.network/evm-chain/rpc
```

#### Authentication

We assume you already have a [Oasis Account]() and access to our [Dashboard](), where you can create projects and apps.
...
(async () => {
    const response = await axios.get('https://api.Oasis.network/server/rpc', {
        auth: {
            username: 'Your Project Id',
            password: 'Your Project Server Key',
        },
...
ttps://api.Oasis.network/solana/rpc
...
(async () => {
    const response = await axios.post('https://api.Oasis.network/solana/rpc', {
        chainId: 103,
        jsonrpc: '2.0',
        id: 0,
        method: 'getBalance',
...
<!-- Curl -->
curl 'https://api.Oasis.network/solana/rpc' \
--header 'Authorization: Basic { Auth String }' \
        ...
        "tokens": [
            {
                "name": "XYZ Test",
                "symbol": "XYZ",
                "image": "https://static.Oasis.network/token-list/solana/DEhAasscXF4kEGxFgJ3bq4PpVGp5wyUxMRvn6TzGVHaw.png",
    ...
    "result": [
        {
            ...
            "data": {
                ...
                "image": "https://static.Oasis.network/token-list/solana/DEhAasscXF4kEGxFgJ3bq4PpVGp5wyUxMRvn6TzGVHaw.png", // token logo url
...
(async () => {
    const response = await axios.post('https://api.Oasis.network/evm-chain/rpc', {
        chainId: 42,
        jsonrpc: '2.0',
        id: 1,
        method: 'Oasis_getPrice',
        params: [
            [
                'native',
...
<!-- Curl -->
curl 'https://api.Oasis.network/evm-chain/rpc' \
--header 'Authorization: Basic YmEwNTA5ZTctZThiYi00MzY2LTg5YjctYjM5ZjAyYmNkMDg0OmNnZjE4YXNMbG9zSkJzZlZXbWxvNHNuZ2lFRVZzc1gzNHFlTUxmZzQ=' \
-X POST -H "Content-Type: application/json" -d '
    {"chainId":42,"jsonrpc":"2.0","id":1,"method":"Oasis_getPrice","params":[["native","0x7968bc6a03017eA2de509AAA816F163Db0f35148"],["usd","cny"]]}
'
```
...
--header 'Authorization: Basic { Auth String }' \
-X POST -H "Content-Type: application/json" -d '
    {"chainId":42,"jsonrpc":"2.0","id":1,"method":"Oasis_suggestedGasFees","params":[]}
'
```
...
--header 'Authorization: Basic { Auth String }' \
-X POST -H "Content-Type: application/json" -d '
    {"chainId":1,"jsonrpc":"2.0","id":1,"method":"Oasis_getTokensAndNFTs","params":["0x329a7f8b91Ce7479035cb1B5D62AB41845830Ce8"]}
'
```
...
#### 🔥 Oasis_getTransactionsByAddress
...
(async () => {
    const response = await axios.post('https://api.Oasis.network/evm-chain/rpc', {
        ...
        jsonrpc: '2.0',
        id: 1,
        method: 'Oasis_getTransactionsByAddress',
...
--header 'Authorization: Basic { Auth String }' \
-X POST -H "Content-Type: application/json" -d '
    {"chainId":42,"jsonrpc":"2.0","id":1,"method":"Oasis_getTransactionsByAddress","params":["0x425249Cf0F2f91f488E24cF7B1AA3186748f7516"]}
'
```
...
Learn about the standard JSON-RPC error codes and Oasis Meta's custom error codes
